...
handoffs:
  - label: JSON Schema Expert
    agent: "JSON Schema Expert"
    prompt: Implement the plan
    send: true
  - label: XML Schema Expert
    agent: "XML Schema Expert"
    prompt: Implement the plan
    send: true
---
...
- JSON requests go to JSON Schema Expert.
- XML requests go to XML Schema Expert.

## Routing rules
1. If the input or target file is JSON or *.schema.json, hand off to JSON Schema Expert.
